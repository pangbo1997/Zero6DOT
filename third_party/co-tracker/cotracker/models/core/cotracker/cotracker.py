...
class CoTracker(nn.Module):
    ...
    def forward_iteration(
        ...
        return coord_predictions, vis_e, feat_init, ffeats

    def forward(self, rgbs, queries, iters=4,K=None, feat_init=None, is_train=False):
        ...
        ffeats=torch.zeros((B,T,N,128),device=device)
        ...
        while ind < T - self.S // 2:
            ...
            # import pdb;pdb.set_trace()
            coords, vis, __,_ffeats= self.forward_iteration(
                fmaps=fmaps,
            ...
            ffeats[:,ind:ind+self.S,:wind_idx]=_ffeats[:,:S_local]
            # import pdb;pdb.set_trace()
        ...
        return traj_e, feat_init, vis_e, train_data,ffeats

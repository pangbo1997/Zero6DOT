...
if __name__ == "__main__":
    ...
    # with open(args.input_models_path, "r") as f:
    #     model_paths = [f'/data/shapenet/03001627/{line.strip()}/models/model_normalized.obj' for line in f]
    with open(args.input_models_path, "r") as f:
        model_paths = [f'/data/omni/{line.strip()}/Scan/Scan.obj' for line in f]
    model_paths = sorted(model_paths)
    # model_paths = sorted(glob.glob('/data/shapenet/02958343/*/models/*.obj'))[:200]
